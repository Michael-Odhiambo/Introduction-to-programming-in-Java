 ...
 */
public class AnimationStarter extends Application {
    ...
    public void drawFrame(GraphicsContext g, int frameNumber, double elapsedSeconds, int width, int height) {
        ...
        double inset;  // Gap between edges of the drawing area and the outer rectangle.

        double rectWidth, rectHeight;  // The size of one of the rectangles.
        g.setStroke( Color.BLACK );  // Draw rectangle outlines.
        inset = frameNumber % 15 + 0.5;  // The 0.5 is a technicality that gives a sharper picture.
