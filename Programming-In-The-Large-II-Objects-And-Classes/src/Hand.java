...
public class Hand {
     ...
     * @throws IllegalArgumentException if the position does not exists in the hand,
     * that is the position is less than 0 or greater than or equal to the number
     * of cards in the hand.
     */
    public void removeCard( int position ) {
        if ( position < 0 || position >= hand.size() )
            throw new IllegalArgumentException( "Position does not exist i hand: " + position );
     ...
     * @throws IllegalArgumentException if position does not exists in the hand.
     */
