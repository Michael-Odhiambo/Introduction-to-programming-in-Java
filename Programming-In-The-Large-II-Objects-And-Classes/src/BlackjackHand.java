...
public class BlackjackHand extends Hand {
    ...
    public int getBlackjackValue() {
        ...
        // If there is an ace, and if changing its value from 1 to 11
        // would leave the score less than or equal to 21, then do so
        // by adding the extra 10 points to val.
        if ( ace == true && val + 10 <= 21 )
            val = val + 10;
        return val;

    }  // end of getBlackjackValue()
