...
public class GrowingCircleAnimation extends Application {
    ...
    /**
     * Draw one frame of the animation. If there is no disk data ( which is true for
     * the first frame), 100 disks with random locations, colors, and radii are
     * created. In each frame, all the disks grow by one pixel per frame. Disks
     * sometimes disappear at random, or when their radius reaches 100. When a disk
     * disappears, a new disk appears with radius 1 and a random location and color.
     */
