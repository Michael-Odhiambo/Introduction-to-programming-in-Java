...
public class Card {
    ...
    // Codes for the non-numeric cards. Cards 2 through 10 have
    // their numerical values for their codes.
     ...
     * 1 through 12, with 1 representing ACE. For a JOKER, the value
     * can be anything. The value cannot be changed after the card is
     * constructed.
     */
     ...
     * the string is always numerical.
     */
     ...
     * @return one of the string "Spades", "Hearts", "Diambonds", "Clubs"
     * or "Joker".
     */
