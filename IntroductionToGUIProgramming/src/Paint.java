/**
 * A simple program where the user can sketch curves in a variety of colors.
 * A color palette is shown along the right edge of the canvas. The user can
 ...
 * user draws by clicking and dragging in a large area that occupies most of the
 * canvas.
 */
...
public class Paint extends Application {
    ...
    /**
     * Array of colors corresponding to the available colors in the palette.
     */
    private final Color[] palette = { Color.BLACK, Color.RED, Color.GREEN, Color.BLUE,
    ...
    /**
     * The start() method creates the GUI, sets up event listening, and shows the window
     * on the screen.
     */
    public void start( Stage stage ) {
        ...
        canvas.setStyle( "-fx-padding: 5px; -fx-border-color: grey; -fx-border-width: 3px; -fx-background-color: black" );
    ...
    public void clearAndDrawPalette() {
         ...
         * right corner of the canvas, allowing for a 3-pixel border.
         */
        g.setFill( Color.WHITE );
        ...
        /**
         * Draw a 2-pixel white border around the color rectangle of the
     ...
     * color palette at a point with y-coordinate y.
     */
     ...
     * ( or do nothing if the user clicks on the border. )
     */
    public void mousePressed( MouseEvent evt ) {

        /**
         * Ignore mouse presses that occur when the user is already
         * drawing a curve. ( This can happen if the user presses two
        ...
        if ( x > width - 53 ) {
            ...
            // This click is either on the clear button or on the
            // color palette.
            if ( y > height - 53 )
     ...
     * to the current mouse location, and set up prevX and prevY for for the next call.
