...
public class Deck {
     ...
     * are in a sorted order. The shufle() method can be called to
     ...
     * are in a sorted order. The shuffle() method can be called
     ...
     * are still left in the deck. The return value would be 52 or 54
     * ( depending on whether the deck includes Jokers ) when the deck is
     * first created or after the deck has been shuffled. It decreases by
     * 1 each time the dealCard() method is called.
     */
